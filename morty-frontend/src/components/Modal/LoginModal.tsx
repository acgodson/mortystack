...
import {
    ...
    ModalContent,
    ModalHeader,
    ModalOverlay, Tabs, TabList, TabPanels, Tab, TabPanel, useToast, HStack, Text
...
const LoginModal = ({ isOpen, onClose, page = 0 }: any) => {
    ...
    const { loginWeb3, setUserCookie, mapUserData, isGoogleSignIn, setIsGoogleSignIn }: any = useWeb3AuthProvider()
                        ...
                        <TabPanels>
                            <TabPanel>
                                ...
                                <Button
                                    ...
                                    colorScheme="blue"
                                    width={"100%"}
                                    isDisabled={email.length < 3 ? true || password.length < 3 ? true : false : false}
                                    isLoading={signingIn}
