...
import {
    ConnectType,
    useEthereumProvider,
} from "@/contexts/WormholeContext/EthereumWalletContext";
...
const PaymentPage: React.FC = () => {
    ...
    const SubmitPayment = async ({
        ...
        const result = await typedClient.appClient.getBoxValue(
        ...
        if (result) {
            ...
            try {
                ...
                setSuccess(true);
                const paymentChannel = new BroadcastChannel("xxyx");
                    ...
                    paymentChannel.postMessage(additionalData);
    ...
    async function getPrice() {
        ...
        let bodyContent = JSON.stringify({
            symbol:
                parsedToken.symbol === "WMATIC"
                    ? "MATIC"
                    : parsedToken.symbol === "WETH"
                        ? "ETH"
                        : parsedToken.symbol === "WALGO"
                            ? "ALGO"
                            : parsedToken.symbol,
        });
        ...
        if (data.usdPrice) {
            const equiv = getEquivalentAmount(
                data.usdPrice,
            ...
            case "true":
                return (
                    <VStack align={"center"}>
                        ...
                        <Text color="#81e6d9" mt="4" fontWeight="bold">
                            Transaction Successful
                        </Text>
                        <Text textAlign={"center"} fontSize={"sm"}>
                            You an Claim Receipt After Seller has Retrieved Payment{" "}
                        </Text>
        ...
        <Box>
            <Center h="100vh">
                <VStack w="100%" alignItems="center">
                    {!success && (
                        <>
                            ...
                            <Box
                                ...
                                position={"absolute"}
                            >
                                <HStack pb={"20px"} as="button" onClick={() => setPageIndex(0)}>
                                    <MdArrowBack />
                                                                    ...
                                                                    <Box py={5} w="100%">
                                                                        ...
                                                                        <Box w="100%" pt={8}>
                                                                            <Button
                                                                                ...
                                                                                isLoading={isPaying}
                                                                                isDisabled={
                                                                                    !activeAddress || !balanceConfirmed
                                                                                }
                    ...
                    {!success && pageIndex !== 0 && pageIndex !== 1 && (
                        <BridgeSteps active={activeStep} />
                    )}
